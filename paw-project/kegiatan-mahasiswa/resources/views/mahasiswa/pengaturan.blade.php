...
<div class="mb-6">
    ...
    <p class="text-gray-500 text-sm mt-0.5">Kelola keamanan akun Anda</p>
</div>

<div class="bg-white rounded-2xl border border-gray-100 p-6 max-w-lg">
    <h2 class="font-bold text-gray-900 mb-1">Ubah Password</h2>
    <p class="text-xs text-gray-400 mb-5">Pastikan password baru Anda kuat dan mudah diingat</p>
